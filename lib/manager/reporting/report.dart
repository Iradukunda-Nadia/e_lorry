...
reportView(context) async {
  ...
  StorageReference firebaseStorageRef = FirebaseStorage.instance.ref().child("report");
  StorageUploadTask upload = firebaseStorageRef.putFile(file,);
  StorageTaskSnapshot taskSnapshot=await upload.onComplete;
  String fileUrl= await taskSnapshot.ref.getDownloadURL();

  material.Navigator.of(context).push(
    material.MaterialPageRoute(
      builder: (_) => PdfViewerPage(path: fileUrl),
    ),
  );
