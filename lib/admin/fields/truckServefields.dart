...
class truckSerFields extends StatefulWidget {
  @override
  _truckSerFieldsState createState() => _truckSerFieldsState();
}

class _truckSerFieldsState extends State<truckSerFields> {
  bool readOnly = false;
              ...
              onPressed: () {
                ...
                Firestore.instance.runTransaction((Transaction transaction) async {
                  ...
                  eventsQuery.documents.forEach((msgDoc) {
                    msgDoc.reference.updateData({'truckSerForm': 'created'});
                  });

                  await Firestore.instance.collection('field')
                      .document('${userCompany}-serve')
                ...
                child: FormBuilder(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      new Flexible(
                          child: StreamBuilder(
                              stream: Firestore.instance.collection('field').document('elorry-serve').snapshots(),
                                  ...
                                  child: Column(
                                    children: <Widget>[
                                      ...
                                      new FormBuilderCheckboxList(
                                        decoration:
                                        InputDecoration(labelText: "Battery"),
                                        attribute: "Battery",
                                        options:  userDocument['Battery']
                                      ...
                                      new FormBuilderCheckboxList(
                                        decoration:
                                        InputDecoration(labelText: "Fuel"),
                                        attribute: "Fuel",
                                        options:  userDocument['Fuel']
                                            .map<FormBuilderFieldOption>(
                                              (val) => FormBuilderFieldOption(
                                            value: val,
                                            child: Text(val,),
                                      ...
                                      new FormBuilderCheckboxList(
                                        decoration:
                                        InputDecoration(labelText: "KM. when"),
                                        attribute: "KM. when",
                                        options:  userDocument['KM. when']
                                            .map<FormBuilderFieldOption>(
                                              (val) => FormBuilderFieldOption(
                                            value: val,
                                            child: Text(val,),
                                      ...
                                      new FormBuilderCheckboxList(
                                        decoration:
                                        InputDecoration(labelText: "Specifics"),
                                        attribute: "Specifics",
                                        options:  userDocument['Specifics']
                                            .map<FormBuilderFieldOption>(
                                              (val) => FormBuilderFieldOption(
                                            value: val,
                                            child: Text(val,),
